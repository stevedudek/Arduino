...
// CHECK whether this is a problem
...
uint8_t colors = 3;  // color scheme: 0 = all, 1 = red, 2 = blue, 3 = yellow
...
uint8_t fade_amount = 200;  // 0 = no fading, to 255 = always be fading
...
#define ARE_CONNECTED true  // Are the umbrellas talking to each other?
...
void morph_channels() {
  ...
  if (update_leds) { 
    adj_brightess();  // Is this necessary?
    FastLED.show();
  }
}
