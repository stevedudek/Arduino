...
#define NumLEDs     4        // Sides
#define NumNeigh    3        // Neighbors
#define Solid_ID    1        // 1 = tet, 2 = cube, 3 = oct, 4 = dodec, 5 = icosa
#define MAX_SOLID   5
...
// Colors
int foreColor = 1024;   // Foreground color
...
boolean I_AM_MASTER = false; // true if master; false if slave
...
void SpeakSignal() {
  ...
  byte chapter = 2;  // For single mode
  byte currSolid;
