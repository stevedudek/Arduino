 ...
 */
for (i=0;i<10;i++) {
  LightUp(B00000, B01000000, 50);
  LightUp(B00000, B10100000, 50);
  LightUp(B00001, B00010000, 50);  
  LightUp(B00010, B00001000, 50);
  LightUp(B00100, B00000100, 50);
  LightUp(B01000, B00000010, 50);
  LightUp(B10000, B00000001, 50);
}
