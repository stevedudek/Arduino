...
#define START_SHOW_CHANNEL_B   5  // Starting show for Channels B. One of these needs to be 0.
  ...
  for (uint8_t i = 0; i < DUAL; i++) {
    ...
    switch (current_show[i]) {
      ...
      case 0:
        ...
        break;
      case 1:
        shows[i].fireflies(); // no (missing half of the spokes)
        break;
      case 2:
        shows[i].sparkfire();  // no  (just the first few pixels)
        break;
      case 3:
        shows[i].edgeburst();  // sucks: blinky
        break;
      case 4:
       shows[i].sunrise();  // bad too
        break;
      case 5:
        shows[i].halloween_color_twinkle();
        break;
      case 6:
