...
#define DELAY_TIME 10 // in milliseconds. A cycle takes 3-5 milliseconds, so make this 6+.
long last_time;
...
#define START_SHOW_CHANNEL_B 17  // Starting show for Channels B. One of these needs to be 0.
...
void morph_channels(uint8_t fract) {
  ...
  for (int i = 0; i < NUM_LEDS; i++) {
    ...
    if (led_number != XX) {
      leds[led_number] = led[CHANNEL_A].getInterpHSV(leds_buffer[CHANNEL_B][rotate_pixel(i, CHANNEL_B)], 
