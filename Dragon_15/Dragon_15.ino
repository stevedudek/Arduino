...
// packets - CHECK THIS
// patterns - CHECK THIS
// verticle moving bars (up and down) diagonaxl moving bars (make general) - CHECK THIS
  ...
  for (uint8_t i = 0; i < DUAL; i++) {
    ...
    switch (current_show[i]) {
      ...
      case 15:
        ...
        break;
      case 16:
        shows[i].packets();  // NEEDS TESTING!
        break;
      case 17:
        shows[i].packets_two();  // NEEDS TESTING!
        break;
      case 18:
        shows[i].moving_bars();  // NEEDS TESTING!
        break;
      case 19:
        shows[i].expanding_drops();  // NEEDS TESTING!
        break;
      default:
