...
#define DATA_PIN  11  // 13  // 0  // 11
#define CLOCK_PIN  13  // 14  // 2  // 13
...
//  Serial.begin(9600);
  ...
  // 50 KHZ is too slow; 10 MHZ is too fast
//  FastLED.addLeds<WS2801, DATA_PIN, CLOCK_PIN, RGB, DATA_RATE_KHZ(100)>(leds, TOTAL_LEDS);
