...
//
// back forth dots - vertical dots moving back and forth
//
void back_forth_dots() {
  int8_t i;
  uint8_t temp_x;
...
//
// back forth bands - vertical bands moving back and forth
//
void back_forth_bands() {
  int8_t i;
...
//
// back forth colors - vertical colors moving back and forth
//
void back_forth_colors() {
  int8_t i;
  uint8_t temp_x, hue;
