...
// Clocks and time
#define SHOW_DURATION 120  // Typically 30 seconds. Size problems at 1800+ seconds.
uint8_t FADE_TIME = 80;  // seconds to fade in. If FADE_TIME = SHOW_DURATION, then Always Be Fading
...
void corner_ring(uint8_t c) {
  ...
  ring(c, shows[c].getForeColor(), BLACK, x, y, 32, 64, 255);
}
