...
#define DATA_PIN 3  // CHANGED!
#define CLOCK_PIN 4  // CHANGED!
...
#define FADE_TIME 0   // seconds to fade in. If FADE_TIME = SHOW_DURATION, then Always Be Fading
...
void setup() {
  ...
  Serial2.begin(9600);  // Serial2: Bluetooth serial
...
//
// check_phone - poll the phone for updated values
//
void check_phone() {
