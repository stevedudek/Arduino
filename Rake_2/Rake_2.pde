 ...
 */
for (i=0;i<10;i++) {
  LightUp(B00000, B00000000, 200-10*i);
  LightUp(B00000, B00000010, 200-10*i);
  LightUp(B00000, B00000100, 200-10*i);
  LightUp(B00000, B00001000, 200-10*i);
  LightUp(B00000, B00010000, 200-10*i);
  LightUp(B00000, B00100000, 200-10*i);
  LightUp(B00000, B01000000, 200-10*i);
  LightUp(B00000, B10000000, 200-10*i);
  LightUp(B00001, B00000000, 200-10*i);
  LightUp(B00010, B00000000, 200-10*i);
  LightUp(B00100, B00000000, 200-10*i);
  LightUp(B01000, B00000000, 200-10*i);
  LightUp(B10000, B00000000, 200-10*i);
}
...
for (i=0;i<10;i++) {
  ...
  LightUp(B00000, B10100000, 70);
  LightUp(B00000, B01000000, 70);
  LightUp(B00000, B10100000, 70);
  LightUp(B00001, B00010000, 70);
  LightUp(B00010, B00001000, 100);
  LightUp(B00100, B00000100, 140);
