...
#define HUB_LENGTH 1  // 1 = Small, 2 = Medium, 1 = Large
...
#define FADE_TIME 20   // seconds to fade in + out
...
void advance_brightness_clock() {
  ...
  spoke_brightness =  map8(sin8_C(brightness_clock), 96, 255); // lerp8by8(min, max, 0-255 fract  
}
