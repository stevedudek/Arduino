...
// drops shows: make a function that draws hexagons
// exploding drops
// packets - CHECK THIS
// check patterns
// verticle moving bars (up and down) diagonal moving bars (make general)
// import Hex shorts: orbits, wipers, well, rain, vert_back_forth_colors, diag_back_forth_dots
