...
//      leds[i] = color;
      ...
      leds[NUM_LEDS] = led[CHANNEL_A].smooth_rgb_color(leds[NUM_LEDS], rgb_color, 4);  // symmetry!
      leds[ACTUAL_LEDS - NUM_LEDS - 1] = led[CHANNEL_A].smooth_rgb_color(leds[ACTUAL_LEDS - NUM_LEDS - 1], rgb_color, 4);  // symmetry!
