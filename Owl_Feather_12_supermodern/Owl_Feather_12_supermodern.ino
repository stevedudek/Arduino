...
void morph_channels_for_pixel(uint8_t f, uint16_t led_number, uint8_t feather_size, uint8_t fract) {
  CRGB rgb_color;
  ...
  // Removed smoothing backstop. smooth constants should be large.
