 ...
 */
for (i=0;i<5;i++) {
  LightUp(B00000, B01000000, 250); 
  LightUp(B00000, B00000000, 250);
}

/*
 * Show - travelling darkness
 */
for (i=0;i<3;i++) { 
  LightUp(B11111, B11111111, 100);
  LightUp(B01111, B11111110, 100);
  LightUp(B10111, B11111101, 100);
  LightUp(B11011, B11111011, 100);
  LightUp(B10101, B11110111, 100);
  LightUp(B11010, B11101111, 100);
  LightUp(B11111, B01011111, 100);
  LightUp(B11110, B10111111, 100);
  LightUp(B11111, B00011111, 100);
  LightUp(B11110, B00001111, 100);
  LightUp(B11100, B00000111, 100);
  LightUp(B11000, B00000011, 100);
  LightUp(B10000, B00000001, 100);
  LightUp(B00000, B00000000, 100);
}

/*
 * Show - All lights blink progressively faster
 */
for (i=0;i<21;i++) {
  LightUp(B00000, B00000000, 200-i*10);
  LightUp(B11111, B11111111, 200-i*10);
}  
/*
