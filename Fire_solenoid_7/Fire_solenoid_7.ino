...
#define FLAME_WAIT_MIN (40 * CLOCK_FREQ)   // seconds
#define FLAME_WAIT_MAX (80 * CLOCK_FREQ)  // seconds
...
void run_flame_show() {
  ...
  switch (flame_show) {
      ...
      case 5:
        ...
        break;
      case 6:
        spurt_flame(6, 1);  // 8 second burst of 25% flames
        break;
      case 7:
        spurt_flame(2, 3);  // 3 second burst of 75% flames
        break;
