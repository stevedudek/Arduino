...
//
//  Owl with FastLED - Huge port off of Dragon library code
//
//  MESH network! — Supermodern library
//
...
void updateLeds() {
  ...
  for (uint8_t i = 0; i < DUAL; i++) {
    ...
    head_led[i].morph_frame(shows[i].getMorphFract());  // similar to shows[i].morphFrame()
...
void run_shows(uint8_t i) {
  ...
  switch (current_show[i]) {
    ...
    case 0:
      shows[i].patterns();  // Check why these changes so much
      break;
    case 1:
    ...
    case 3:
      ...
      break;
    case 4:
      shows[i].plinko();  // whitening?
      break;
    case 5:
      shows[i].randomTwoColorBlack();  // why keeps changing?
      break;
    case 6:
    ...
    case 7:
      ...
      break;
    case 8:
      shows[i].bounce();  // green>
      break;
    case 9:
      shows[i].bounceGlowing();  // green
      break;
    case 10:
    ...
    case 18:
      ...
      break;
    case 19:
      shows[i].expanding_drops(false);  // white edge problem
      break;
    case 20:
