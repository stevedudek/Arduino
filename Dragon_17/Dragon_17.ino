...
uint8_t section_list[] = { SECTION_A };
...
#define NUM_SCALES   (86 + 47)  // set this manually
#define NUM_SPACERS  (17 + 13)  // set this manually
//#define NUM_SCALES   (87 + 101 + 97 + 46)  // set this manually
...
// Shows
#define START_SHOW_CHANNEL_A  27
  ...
  for (uint8_t i = 0; i < DUAL; i++) {
    ...
    switch (current_show[i]) {
      ...
      case 10:
        ...
        break;
      case 11:
       shows[i].vert_back_forth_dots();  // NEEDS TESTING!
        break;
      case 12:
        shows[i].vert_back_forth_bands();  // NEEDS TESTING!
        break;
      case 13:
        shows[i].vert_back_forth_colors();  // NEEDS TESTING!
        break;
      case 14:
        shows[i].diag_back_forth_dots();  // NEEDS TESTING!
        break;
      case 15:
        shows[i].diag_back_forth_bands();  // NEEDS TESTING!
        break;
      case 16:
        shows[i].diag_back_forth_colors();  // NEEDS TESTING!
        break;
      case 17:
      ...
      case 22:
        ...
        break;
      case 23:
        shows[i].packets_two();  // work
        break;
      case 24:
        shows[i].moving_bars(false);  // get_coord_col_min_y MAY NOT WORK
        break;
      case 25:
        shows[i].moving_bars(true);  // get_coord_col_min_y MAY NOT WORK
        break;
      case 26:
        shows[i].expanding_drops(false);  // NEEDS TESTING!
        break;
      case 27:
        shows[i].expanding_drops(true);  // NEEDS TESTING!
        break;
      default:
...
void pick_next_show(uint8_t i) {
  ...
  // current_show[i] = (current_show[i] + 1) % NUM_SHOWS;
