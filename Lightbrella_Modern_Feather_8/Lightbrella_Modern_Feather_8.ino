...
#define DELAY_TIME 50  // in milliseconds (20ms=50fps, 25ms=40fps)
#define SMOOTHING 1   // 0 = no smootåh, lower the number = more smoothing
...
// Shows
#define START_SHOW_CHANNEL_A   3  // Starting show for Channels A. One of these needs to be 0.
...
// POTS
#define HAS_POT true  // Knob attached
