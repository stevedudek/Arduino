...
const char* ssid = "Neon Dinosaur";
const char* password = "R0@r&R0@r"; // password for your MESH
...
#define led1_pin 0  // red LED (low = on)
#define led2_pin 2  // blue LED
...
void setup(void) {
  // Set the LED pins to act as digital outputs and set them off initially
  pinMode(led1_pin, OUTPUT);
  pinMode(led2_pin, OUTPUT);
  digitalWrite(led1_pin, HIGH);  // If set LOW, this will boot-load = bad
  digitalWrite(led2_pin, LOW);
