...
const uint8_t spacer_leds[] PROGMEM = { 
...
#define NUM_PATTERNS 21   // Total number of patterns, each 5 bytes wide
...
boolean get_bit_from_pattern_number(uint8_t n, uint8_t pattern_number) {
  uint8_t pattern_byte = pgm_read_byte_near(PatternMatrix + (pattern_number * 18) + (n / 8) );
