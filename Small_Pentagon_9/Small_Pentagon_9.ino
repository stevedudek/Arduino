...
//  6/19/21
//
//  DOES NOT WORK: ArduinoBlue wireless bluetooth controller (ArduinoBlue)
//
...
//  check_phone();  // Check the phone settings (ArduinoBlue)  // WARNING: This turns off the system
  ...
  if (sliderId != -1) {
    ...
    switch (sliderId) {
      ...
      case HUE_WIDTH_SLIDER:
        ...
        break;
      case SPEED_SLIDER:
        DELAY_TIME = map8(sliderVal, 20, 100);
        break;
