...
#define NUM_LEDS 150  // 28 + 20 Y (closer to 0.72 ratio)
...
// 12 Ys * 136 = 1632 LEDs
// Large Y each = 76 + 76 + 108 = 264 LEDs (possibly 266) * 3 large Ys = 792 LEDs (or 798)
...
#define NUM_TIP_LEDS 6
uint8_t tip_leds[] = { 37, 38, 75, 76, 111, 112  };
