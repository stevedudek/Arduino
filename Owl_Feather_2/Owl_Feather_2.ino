...
Led head_led[] = { Led(NUM_HEAD_LEDS), Led(NUM_HEAD_LEDS) };  // Class instantiation of the 2 Led libraries
Shows head_shows[] = { Shows(&head_led[CHANNEL_A]), Shows(&head_led[CHANNEL_B]) };  // 2 Show libraries
CHSV head_led_buffer[NUM_HEAD_LEDS];  // For smoothing
