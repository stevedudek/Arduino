...
//  FastLED
//
//  Determinant - no randomness
//
#define BRIGHTNESS  100 // (0-255)

#define FISH_NUM 0 // Change for each fish
#define MAX_FISH 2
...
#define FISH_HUE (MAX_COLOR / MAX_FISH) * FISH_NUM  // Main fish color: (https://github.com/FastLED/FastLED/wiki/FastLED-HSV-Colors)
