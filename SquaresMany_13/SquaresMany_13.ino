...
//
//  10/27/24 - For Adam's 3 x 3 = 9 display — with brightness limiter
//
...
#define MAX_BRIGHTNESS  128  // 0–255 with 255 = 2 channels of RGB at full power
...
void adj_brightess() {
  ...
  lumens = lumens / (NUM_LEDS * 2);  // 0-255
  
  if (lumens > MAX_BRIGHTNESS) {  // we are too bright
    FastLED.setBrightness( 255 * MAX_BRIGHTNESS / lumens );
  }
}
