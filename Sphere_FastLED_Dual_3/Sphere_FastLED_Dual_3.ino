...
// ToDo: 1. Symmetries, like with Snowflakes (face, etc.)
//       2. Effects shows (hue, saturation, value - change width - constant center) (DONE?)
...
CHSV add_effect(CHSV color, uint8_t effect_amount, uint8_t effect_fract) {
  ...
  switch(effect_number) {  
    ...
    case 0:  // hue
      ...
      break;
    case 1:  // sat
      color.s = lerp8by8(color.s, map8(effect_amount, 128, 255), effect_fract);
      break;
    case 2:  // value
...
uint8_t get_effect_amount(uint8_t i) {
  return beatsin8( EffectBeatsPerMinute, 0, 255) - get_distance(i, center_pixel);
}
