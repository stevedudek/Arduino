...
// Shows
#define START_SHOW_CHANNEL_A  25  // Starting show for Channels A. One of these needs to be 0.
  ...
  for (uint8_t i = 0; i < DUAL; i++) {
    ...
    switch (current_show[i]) {
      ...
      case 5:
        ...
        break;
      case 6:
        shows[i].morphChain();  // Very bright!
        break;
      case 7:
...
void set_show_variables(uint8_t i) {
  ...
  switch (current_show[i]) {
    ...
    case 0:  // randomFill
      ...
      break;
    case 5:
      led[i].turnOffLedMap();  // Pendulum Wave
    ...
    case 11:
      ...
      break;
    case 22:
      led[i].turnOffLedMap();  // center_ring
      break;
    case 23:
      led[i].turnOffLedMap();  // corner_ring
