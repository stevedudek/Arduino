...
//
//  Mohawk! - Only 10 Lights. This version DOES NOT use an ACCELEROMETER
//
/*****************************************************************************/
//
// Set Up Pins
...
void loop() {
  ...
  switch(random(6)) {
    ...
    case 4:
      ...
      break;
    case 5:
      lightrunup(random(1,4));
      break;
  }
  
  // No accelerometer - clear, delay, return
  
  clear();
  strip.show();
  delay(10000*random(5,10));
  return;
  
  // Then the accelerometer show
  //accelshow(random(100,500));
}
