...
#define START_SHOW_CHANNEL_B  8  // Channels B starting show
uint8_t current_show[] = { START_SHOW_CHANNEL_A, START_SHOW_CHANNEL_B };
#define NUM_SHOWS 22

#define START_HEAD_SHOW_CHANNEL_A  0  // Channels A starting show
#define START_HEAD_SHOW_CHANNEL_B  6  // Channels B starting show
...
void updateLeds() {
  ...
  for (uint8_t i = 0; i < DUAL; i++) {
    ...
    switch (current_show[i]) {
      ...
      case 0:
        // test_pattern(i);
        shows[i].patterns();   // might work
        break;
      case 1:
        shows[i].juggle_fastled();  // works
        break;
      case 2:
        shows[i].sinelon_fastled();  // a bit crazy
        break;
      case 3:
        shows[i].tubes();  // works
        break;
