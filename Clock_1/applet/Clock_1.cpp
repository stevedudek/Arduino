...
void CycleLights(int data2, int delaytime);
void CycleLightsWithHold(int hold, int data2, int delaytime);
void Clock();
void loop();
int i = 0;
int j = 0;
...
void Clock() {   // runs a "clock" cycle of 12 hours
  ...
  for (j=0;j<12;j++) {         // Hour's cycle of 12 hours
    ...
    CycleLightsWithHold(hold, data2, 50);      // Run 1 hour
 ...
 */
for (j=0;j<10;j++) { CycleLights(1, 100-10*j); }
 ...
 */
for (j=0;j<20;j++) {
  LightUp(B00001010, B10101010, 100);
  LightUp(B00000101, B01010101, 100);
}
 ...
 */
for (j=0;j<10;j++) {
  LightUp(B00000000, B00000001, 100-10*j);
  LightUp(B00001000, B00000011, 100-10*j);
  LightUp(B00001100, B00000111, 100-10*j);
  LightUp(B00001110, B00001111, 100-10*j);
  LightUp(B00001111, B00011111, 100-10*j);
  LightUp(B00001111, B10111111, 100-10*j);
  LightUp(B00001111, B11111111, 100-10*j);
  LightUp(B00000111, B11111110, 100-10*j);
  LightUp(B00000011, B11111100, 100-10*j);
  LightUp(B00000001, B11111000, 100-10*j);
  LightUp(B00000000, B11110000, 100-10*j);
  LightUp(B00000000, B01100000, 100-10*j);
  LightUp(B00000000, B00000000, 100-10*j);
}
