...
#define MIN_DELAY_CYCLES  5
#define MAX_DELAY_CYCLES 50
...
uint8_t FADE_TIME = 30;  // seconds to fade in. If FADE_TIME = SHOW_DURATION, then Always Be Fading
      ...
      if (i != XX) {
        ...
        if (value) {
          ...
          if (pattern_type < 2) {
            ...
            uint8_t intense = get_wipe_intensity(x, y, pattern[c + 6], c, (pattern_type < 4));
