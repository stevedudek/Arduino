 ...
 *   Octahedron   
 *
 *   Cone Chandelier - Light 8 Macetech LED cones with patterns through two Octobars
 *
...
byte Opposite[NumLEDs] = { 7,6,5,4,3,2,1,0 };  // Opposite faces of the dodecahedron
byte neighbors[][3] = {  // 3 neighbors to each hex
