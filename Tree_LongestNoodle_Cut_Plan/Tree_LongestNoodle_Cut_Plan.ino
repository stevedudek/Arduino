...
// 56 LEDs on the longest noodle

// 56 LEDs = 73.5" = 6'2" = 52" (one noodle) + 22"
...
// 12 Ys * 136 = 1632 LEDs
// Large Y each = (38 * 4) + (56 * 2) = 152 + 112 = 264 LEDs * 3 large Ys = 792 LEDs
...
#define NUM_TIP_LEDS 4
uint8_t tip_leds[] = { 55, 56, 111, 112  };

#define NUM_Y_LEDS 2
uint8_t y_leds[] = { 0, 149 };
