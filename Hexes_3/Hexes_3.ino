...
// Shows
#define START_SHOW_CHANNEL_A  10  // Starting show for Channels A. One of these needs to be 0.
...
//
// adjust_speed - depends on the show
//
void adjust_speed(uint8_t i, uint8_t current_show) {
  ...
  switch (current_show) {
    ...
    case 0:  // randomFill
      ...
      break;
    case 5:
      shows[i].setColorSpeedMinMax(1,3);  // sawTooth
      break;
    case 19:
